...
function loop() {
  ...
  // Sobald der Spieler mit .blume (In diesem Fall Netzwerke) kollidiert, werden sie gelöscht
  ...
  // Netzwerke (Punkte) werden zufallig platziert
  if (timer2.ready()) {
    let p = document.createElement("img");
    p.setAttribute("src", "img/tecna_netz.png");
